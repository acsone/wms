...
class Reception(Component):
    ...
    def _process(self, picking, line, quantity, action, is_over_reception_confirmed):
        ...
        response = self._set_quantity__process__set_qty_and_split(
            picking, line, quantity, action, is_over_reception_confirmed
        )
        return response

...
We therefore simply use the REST API for admin operations. 
Standard index and document operations are compatible with the standard python
connector up to 7.12; afterwards, the commits listed break compatibility:
...
[se_backend_elasticsearch.elasticsearch_backend]
ssl=False
es_server_host=https://localhost:9200/
es_user=admin
es_password=admin
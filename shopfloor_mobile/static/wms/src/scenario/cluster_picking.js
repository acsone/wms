            ...
            states: {
                ...
                start_line: {
                    display_info: {
                        ...
                        scan_placeholder: this.$t('cluster_picking.start_line.scan_placeholder'),
                    },
                ...
                scan_destination: {
                    display_info: {
                        ...
                        scan_placeholder:  this.$t('cluster_picking.scan_destination.scan_placeholder'),
                    },
                    events: {
                ...
                change_pack_lot: {
                    display_info: {
                        ...
                        scan_placeholder: this.$t('cluster_picking.change_pack_lot.scan_placeholder'),
                    },
                    on_scan: scanned => {
                        this.wait_call(

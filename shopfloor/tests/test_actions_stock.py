...
class TestActionsStock(CommonCase):
    ...
    def test_unmark_move_line_as_picked_full_picking(self):
        ...
        self.stock.unmark_move_line_as_picked(lines)
    ...
    def test_unmark_move_line_as_picked_partial_picking_same_user(self):
        lines = self.picking.move_line_ids
        self.stock.mark_move_line_as_picked(lines)
        self.assertEqual(self.picking.user_id, self.env.user)
    ...
    def test_unmark_move_line_as_picked_partial_picking_different_user(self):
        lines = self.picking.move_line_ids
        ...
        self.stock.unmark_move_line_as_picked(other_line)

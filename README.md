...
docker exec -ti alcyon_db_1 psql -U odoo odoodb  
# run bash in the running odoo container
docker exec -ti alcyon_odoo_1 bash
```
...
The first time:
```bash
git clone git@github.com:camptocamp/alcyon_odoo.git -b 9.0.4 alcyon-test  # use the tag you want to deploy
cd alcyon-test

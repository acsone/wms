...
def create_picking_types(ctx):
    ...
    types = [
        ...
        {'xmlid': '__setup__.stock_picking_type_materiel',
         ...
         'color': color_mat,
         'sequence': 6,
         'picking_zone_id': ctx.env.ref('__setup__.picking_zone_materiel'),
         },
        {'xmlid': '__setup__.stock_picking_type_ali',
         ...
         'color': color_ali,
         'sequence': 5,
         'picking_zone_id': ctx.env.ref('__setup__.picking_zone_aliments'),
        ...
        {'xmlid': '__setup__.stock_picking_type_medoc',
         ...
         'color': color_medoc,
         'sequence': 4,
         'picking_zone_id': ctx.env.ref('__setup__.picking_zone_medicament'),
         },
        {'xmlid': '__setup__.stock_picking_type_froid',
         ...
         'color': color_froid,
         'sequence': 7,
         'picking_zone_id': ctx.env.ref('__setup__.picking_zone_frigo'),
         },
        {'xmlid': '__setup__.stock_picking_type_humain',
         ...
         'color': color_mat,
         'sequence': 8,
         'picking_zone_id': ctx.env.ref('__setup__.picking_zone_humain'),
         },

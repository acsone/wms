...
You need to activate the feature on the picking type.
You can also limit to a max weight.

Usage
=====

Enable the feature on the picking.
Create 2 sales orders with a pick/ship delivery.
You will have 2 delivery orders but only 1 picking.

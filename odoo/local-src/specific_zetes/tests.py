...
def identification():
    ...
    data = '208030824,2.2.3,3iV_101,REQU_USERCONTEXT,{},1,20170207,072932,98427733121320,1,,01,,,,,,,,,,,,,,,,#'.format(USER_CODE)
...
def signoff():
    print '==== Sign Off ===='
    data = '208092662,2.2.3,3iV_101,RESU_USERCONTEXT,{},1,20170207,081534,874277334413394,4,70,,1,Monica Checchi,,,,,,,,,,,,#'.format(USER_CODE)
    result = requests.post(DOMAIN, data=data)
...
def assignment():
    print '==== Assignment ===='
    data = '208030828,2.2.3,3iV_101,REQU_ASSIGNMENT,{},1,20170207,072835,30427733115352,1,1,1,{},,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,#'.format(USER_CODE, ZONE_CODE)
    result = requests.post(DOMAIN, data=data)
...
def validate_picking(picking_id):
    ...
    data = '208030828,2.2.3,3iV_101,RESU_ASSIGNMENT,{},1,20170207,073416,304277331541559,{},,,,04,123456789,,,,,,,,,,#'.format(

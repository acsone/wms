...
class Refdata(DomainInterface):
    ...
    EXAMPLE_RESU = ''
    REQU = ('assignmentType', 'scenarioStatus', 'dataTypeList', 'Cri01',
            'Cri02', 'Cri03', 'Cri04', 'Cri05', 'Cri06', 'Cri07', 'Cri08',
            'Cri09', 'Cri10', 'Usf01', 'Usf02', 'Usf03', 'Usf04', 'Usf05',
            'Usf06', 'Usf07', 'Usf08', 'Usf09', 'Usf10')
    RESP = ('respCode', 'respMsg', 'dataType', 'operValue', 'promptInfo',
            'hostValue', 'Usf01', 'Usf02', 'Usf03', 'Usf04', 'Usf05', 'Usf06',

...
Based on jquery.inputmask 4.x `Docs in GitHub
...
- Aliases:
   ...
   * `Date and Datetime <https://github.com/RobinHerbots/Inputmask/blob/4.x/README_date.md>`_
   * `Numeric <https://github.com/RobinHerbots/Inputmask/blob/4.x/README_numeric.md>`_
   * `Regex <https://github.com/RobinHerbots/Inputmask/blob/4.x/README_regex.md>`_
   * `Phone <https://github.com/RobinHerbots/Inputmask/blob/4.x/README_phone.md>`_
   * `Other <https://github.com/RobinHerbots/Inputmask/blob/4.x/README_other.md>`_""",

...
class TestDeliveryRoundRefillAndBackorders(common.DeliveryRoundTestCase):
    ...
    @classmethod
    def setUpClass(cls):
        super(TestDeliveryRoundRefillAndBackorders, cls).setUpClass()
    ...
    def test_case_23(self):
        ...
        self.assertNotEqual(
            preparation2.delivery_round_id, self.delivery_round_1
        )

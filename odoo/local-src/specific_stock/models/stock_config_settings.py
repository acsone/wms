...
class StockConfigSettings(models.TransientModel):
    ...
    def set_months_between_inventory(self):
        ...
        self.env['ir.config_parameter'] \
            .set_param('stock.months_between_inventory',
                       self.months_between_inventory or '0')
    ...
    def set_delay_inventory_expensive_products(self):
        ...
        self.env['ir.config_parameter'] \
            .set_param('stock.delay_inventory_expensive_products',
    ...
    def set_delay_inventory_best_sellers_products(self):
        ...
        self.env['ir.config_parameter'] \
            .set_param('stock.delay_inventory_best_sellers_products',
    ...
    def check_delay(self, delay):
        ...
        if delay not in [1, 2, 3, 4, 6, 12]:
            raise UserError(_('The delay can only be in the following list:\n'

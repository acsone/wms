...
class TestAlcDeliveryWindow(SavepointCase):
    @classmethod
    def setUpClass(cls):
        ...
        cls.sunday = cls.env.ref(
            "alc_partner_delivery_window.alc_delivery_weed_day_sunday"
        )
    ...
    def test_00(self):
        ...
        self.assertFalse(self.partner_1.alc_delivery_window_ids)
        self.AlcDeliveryWindow.create(
            {
        ...
        self.assertTrue(self.partner_1.alc_delivery_window_ids)
        delivery_window = self.partner_1.alc_delivery_window_ids
    ...
    def test_01(self):
        ...
        self.assertTrue(self.partner_1.alc_delivery_window_ids)
        delivery_window = self.AlcDeliveryWindow.search(
    ...
    def test_03(self):
        ...
        self.assertEquals(len(self.partner_1.alc_delivery_window_ids), 2)
    ...
    def test_04(self):
        ...
        self.assertTrue(self.partner_1.alc_delivery_window_ids)
        self.assertFalse(self.partner_2.alc_delivery_window_ids)
        self.AlcDeliveryWindow.create(
            {
        ...
        self.assertTrue(self.partner_2.alc_delivery_window_ids)

...
class AlcDeliveryWeekDay(models.Model):

    _name = "alc.delivery.week.day"
    ...
    def create(self, vals):
        result = super(AlcDeliveryWeekDay, self).create(vals)
        self._get_id_by_name.clear_cache(self)
        return result

    @api.multi
    def write(self, vals):
        result = super(AlcDeliveryWeekDay, self).write(vals)
        self._get_id_by_name.clear_cache(self)
        return result

    @api.multi
    def unlink(self):
        result = super(AlcDeliveryWeekDay, self).unlink()
        self._get_id_by_name.clear_cache(self)
        return result

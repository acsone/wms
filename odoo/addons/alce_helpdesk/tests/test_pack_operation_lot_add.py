...
class TestPackOperationLotAdd(SavepointCase):
    ...
    def setUpClass(cls):
        ...
        cls.bin2 = cls.StockLocation.create(
            {
                "name": "bin2",
                "location_id": cls.reception_location.id,
                "usage": "internal",
    ...
    def test_receive_surplus_quantities(self):
        # a helpdesk ticket is created of if received more than expected
        # quantities
    ...
    def test_receive_no_surplus_quantities(self):
        # a helpdesk ticket is NOT created of if received more than expected
        # quantities
        picking = self.picking
        # launch wizard
        wiz = self.stock_reception_wizard.with_context(

...
class TestStockPicking(StockReleaseChannelBlockingCommon, BaseCommon):
    ...
    def setUpClass(cls):
        ...
        # The default orderpoint location is the warehouse's view location (VLB)
        cls.warehouse.default_orderpoint_location_id = cls.warehouse.view_location_id
        ...
        cls.env["stock.rule"].create(
            {
                ...
                "location_dest_id": cls.warehouse.default_orderpoint_location_id.id,

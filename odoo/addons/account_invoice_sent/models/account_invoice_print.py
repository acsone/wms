...
class AccountInvoicePrint(models.Model):
    ...
    invoice_ids = fields.Many2many[AccountMove](readonly=True)
    ...
    def _compute_file_name(self):
        for record in self:
            record.fname = f"account_invoice_print_{record.id}.pdf"
    ...
    def generate_report(self):
        ...
        invoices = self.invoice_ids._filter_send_invoice(transmit_method="post")
        ...
        self.state = "done"
        return _("Invoice generation has suceeded")

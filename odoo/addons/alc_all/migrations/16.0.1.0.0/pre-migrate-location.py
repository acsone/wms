...
def _change_columns(env):
    ...
    if openupgrade.column_exists(env.cr, "stock.location", "shelf"):
        ...
        """
        openupgrade.logged_query(query)

    if openupgrade.column_exists(env.cr, "stock.location", "height"):
...
def _update_box(env):
    ...
    sql and orm.
    """
    if openupgrade.column_exists(env.cr, "stock.location", "box"):
        dict_ord = {}

...
class ClusterPickingBatchCase(CommonCase, PickingBatchMixin):
    ...
    def setUpClassVars(cls, *args, **kwargs):
        super(ClusterPickingBatchCase, cls).setUpClassVars(*args, **kwargs)
    ...
    def setUpClassBaseData(cls, *args, **kwargs):
        super(ClusterPickingBatchCase, cls).setUpClassBaseData(*args, **kwargs)
        cls.product_a = (
    ...
    def setUp(self):
        super(ClusterPickingBatchCase, self).setUp()

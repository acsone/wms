...
class LocationContentTransferMixCase(LocationContentTransferCommonCase):
    ...
    def setUpClassUsers(cls):
        super(LocationContentTransferMixCase, cls).setUpClassUsers()
        Users = (
            cls.env["res.users"]
            .sudo()
    ...
    def setUpClassVars(cls, *args, **kwargs):
        super(LocationContentTransferMixCase, cls).setUpClassVars(*args, **kwargs)
        cls.zp_menu = cls.env.ref("alc_shopfloor.shopfloor_menu_zone_picking")
    ...
    def setUpClassBaseData(cls, *args, **kwargs):
        super(LocationContentTransferMixCase, cls).setUpClassBaseData(*args, **kwargs)
    ...
    def setUp(self):
        super(LocationContentTransferMixCase, self).setUp()

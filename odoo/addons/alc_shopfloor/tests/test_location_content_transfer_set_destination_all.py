...
class LocationContentTransferSetDestinationAllCase(LocationContentTransferCommonCase):
    ...
    * /go_to_single
    ...
    def setUpClassBaseData(cls, *args, **kwargs):
        super(LocationContentTransferSetDestinationAllCase, cls).setUpClassBaseData(
            *args, **kwargs
        )
    ...
    def assert_all_done(self, destination):
        ...
        self.assertRecordValues(
            self.pickings.mapped("pack_operation_pack_ids"),
    ...
    def test_set_destination_all_with_partially_available_move_with_ancestor(self):
        ...
        origin_move = move_d.copy({"picking_id": False})
        move_d.move_orig_ids |= origin_move
        ...
        self.assertEqual(self.picking2.move_lines.product_qty, 5.0)
    ...
    def test_set_destination_all_dest_location_move_invalid(self):
        ...
        self.pickings.mapped("move_lines")[0].location_dest_id = self.shelf1
        response = self.service.dispatch(
            "set_destination_all",
            params={
                "location_id": self.content_loc.id,

...
class LocationContentTransferCommonCase(CommonCase):
    ...
    def setUpClassVars(cls, *args, **kwargs):
        super(LocationContentTransferCommonCase, cls).setUpClassVars(*args, **kwargs)
    ...
    def setUpClassBaseData(cls, *args, **kwargs):
        super(LocationContentTransferCommonCase, cls).setUpClassBaseData(
            *args, **kwargs
        )
        cls.content_loc = (
    ...
    def assert_response_start_single(
        ...
        self.assert_response(
            ...
            data=self.service._data_content_operation_for_location(
                location, next(sorter)
            ),
            message=message,
            popup=popup,
        )
    ...
    def _assert_response_scan_destination(
        ...
        data = self.service._data_content_operation_for_location(location, next_content)

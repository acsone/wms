...
class CartService(Component):
    ...
    def _convert_one_line_unit_price(self, line):
        value = super(CartService, self)._convert_one_line_unit_price(line)
    ...
    def _convert_one_line_discount(self, line):
        value = super(CartService, self)._convert_one_line_discount(line)
        value["rate"] = line._get_final_discount()
        return value

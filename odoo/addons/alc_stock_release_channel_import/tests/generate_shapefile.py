...
"""
This script is used to generate the content of the 'resources/' directory.

The files in the resources are used for th test_shape_file_import_wizard.py.
...
for i in range(1, number_of_files + 1):
    ...
    w.record(f"D{i}")  # Name of the polygon D1, D2, ...
    w.close()

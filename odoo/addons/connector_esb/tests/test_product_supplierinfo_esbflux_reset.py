...
class ProductSupplierInfoEsbFluxTestCase(TransactionCase):
    ...
    def test_reset_esbflux_table(self):
        ...
        self.assertEqual(
            self.supinfo_1.ratio_main_product, r_flux.ratio_main_product
        )
        self.assertEqual(
        ...
        self.assertEqual(
            self.supinfo_1.product_tmpl_id.id, r_flux.product_tmpl_id.id
        )
        ...
        self.assertEqual(
            self.supinfo_3.product_tmpl_id.id, r_flux.product_tmpl_id.id
        )

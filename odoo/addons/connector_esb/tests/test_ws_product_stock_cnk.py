...
class WSProductStockCNKTestCase(ESBXMLTestCase):
    ...
    def setup_records(self):
        self.product1 = self.model.create(
            {"name": "Product1", "default_code": "Product1", "cnk_code": "000015"}
        )
        self.product2 = self.model.create(
            {"name": "Product2", "default_code": "Product2", "cnk_code": "000048"}
        )
        self.product3 = self.model.create(
            {"name": "Product3", "default_code": "Product3", "cnk_code": "000115"}
        )
